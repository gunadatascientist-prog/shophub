    ...
    return(
        <div className='container-field1'>
            <div className='container-field2'>
                 <img src={about1} className="about-image" alt="About 1" /> 
                 <img src={about3} className="about-image about-image-2" alt="About 3" />
                 <img src={about4} className="about-image about-image-3" alt="About 4" />
            </div>
