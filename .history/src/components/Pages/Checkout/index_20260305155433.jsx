...
// For testing, you can use the sandbox client ID: "sb" (sandbox)
...
const Checkout = () => {
  ...
  const handlePayPalApprove = (data, actions) => {
    return actions.order.capture().then((details) => {
      ...
      // Store order in localStorage (mock backend)
      const order = {
        id: 'ORD-' + Date.now(),
            ...
            <div className="order-summary">
              ...
              <div className="paypal-button-container">
                {formData.paymentMethod === 'paypal' ? (
                  <>
                    <p className="paypal-note">Pay with PayPal - Safe and Secure</p>
                    <PayPalButtons
