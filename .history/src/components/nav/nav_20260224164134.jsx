                    ...
                    <div className='dropdown_menu Megamenu w-100 '>
                       <div className='row'>
                            ...
                            <ul className='mt-3 mb-0'>
                                ...
                                <li><Link to=""> Feat & Poultry</Link></li>
                            </ul>
                      </div>
                            <div className='col'>
                            <h4>Breakfast & Diary</h4>
                            <ul className='mt-3 mb-0'>
                                <li><Link to="">Meat & Poultry</Link></li>
                                <li><Link to="">Fresh Vegetables</Link></li>
                                <li><Link to="">Herbs & Seasonings</Link></li>
                            ...
                            <div className='col'>
                            <img src="https://wp.alithemes.com/html/nest/demo/assets/imgs/banner/
                            banner-menu.png" className='w-100' ></img>
                            </div>
                            </div>
                            </div>
                    </li>
